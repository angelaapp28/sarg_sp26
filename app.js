...
// COMPLETE UPDATED INFO MODAL SECTION
// Replace the entire info modal rendering section in your renderFlashcard() method
...
this.showInfoPanel ? createElement('div', { className: 'info-overlay', onclick: () => this.toggleInfo() },
  createElement('div', { className: 'info-modal', onclick: (e) => e.stopPropagation() },
    ...
    createElement('div', { className: 'info-content' },
      createElement('p', {}, 
        createElement('strong', {}, 'Strike Zone:'), 
        ' Green circles = attack these locations (whiffs, weak contact). Red circles = avoid (hard contact, balls). The batter icon shows their batting stance.'
      ),
      createElement('p', {}, 
        createElement('strong', {}, 'Pitch Type Abbreviations:'), 
        createElement('br', {}),
        '• 4S = Four-Seam Fastball (straight fastball, most common pitch)', createElement('br', {}),
        '• 2S = Two-Seam Fastball (sinks more than four-seam)', createElement('br', {}),
        '• SI = Sinker (heavy sinking fastball)', createElement('br', {}),
        '• FC = Cutter (fastball that cuts/moves sideways)', createElement('br', {}),
        '• SL = Slider (breaks down and away)', createElement('br', {}),
        '• CB = Curveball (big downward break)', createElement('br', {}),
        '• CH = Changeup (looks like fastball but slower)', createElement('br', {}),
        '• SP = Splitter (drops hard at the end)', createElement('br', {}),
        '• FB = Fastball (generic, when type isn\'t specified)'
      ),
      createElement('p', {}, 
        createElement('strong', {}, 'Vulnerable Zones:'), 
        ' Where batter struggles most. High whiff rates, weak contact, or lots of fouls. Attack here!'
      ),
      createElement('p', {}, 
        createElement('strong', {}, 'Hot Zones:'), 
        ' Danger zones where batter hits hard (95+ mph exit velo). Avoid pitching here.'
      ),
      createElement('p', {}, 
        createElement('strong', {}, 'Out Sequence:'), 
        ' Most common pitch sequences that get this batter out (groundouts, flyouts, strikeouts, etc.). Shows what historically works against them.'
      ),
      createElement('p', {}, 
        createElement('strong', {}, 'Threats:'), 
        ' Steal threat shows base running ability (infield hits, speed indicators). Bunt threat shows contact rate and bat control. Spray chart shows pull/opposite field tendencies.'
      ),
      createElement('p', {}, 
        createElement('strong', {}, 'First-Pitch:'), 
        ' Shows if batter is aggressive (>50% swing rate) or patient on first pitch.'
      )
    ),
